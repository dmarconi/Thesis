...
This chapter covers in details the theoretical background needed by the research presented in this thesis. Starting with the description of the Standard Model, this chapter will analyze its limits and suggest one possible theoretical extension, Supersymmetry. This additional theory comes with a set of solutions to the problems happening in nature that Standard Model still can't describe

\section{The Standard Model of Particle Physics}

The Standard Model of particle physics is a theory that describes the interactions of three of the forces existing in nature, electromagnetic, weak and strong, and defines the fundamental constituents of matter \cite{Spiesberger:2000ks}. It was developed in the second half of the century as combined theoretical and experimental effort by the experimental communities from all around the world. Since the first formulation at the beginning of the 1970s the Standard Model successfully predicted all the particles that were later in the century discovered. The most recent particle discoveries such as the top quark (1995), the tauonic neutrino (2000) and finally the Higgs boson (2012) have given further credence to the Standard Model. 

According to this theoretical model the basic constituent of matter are leptons and quarks which are divided in three families of identical structure. \autoref{table:fermions} shows all the fermions of the Standard Model and their charges, arranged in the three families. Details on the main aspects of this theory are gonna be given in the following sections.
...
The discovery of the Higgs boson lead to the confirmation of the mechanism that was developed in 1964 to face the problem of a symmetric Lagrangian with massless particles which was not representing experimental evidence. This mechanism works by introducing a gauge boson and spontaneously breaking the symmetry.
...
and $F^{\mu\nu}$ is the tensor of the vectorial field $A_{\mu}$:
