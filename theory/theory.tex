...
\begin{table}
	...
	\end{tabular}
	\caption{
		The twelve gauge bosons or force carriers of the Standard Model and the corresponding force and force range, and the Higgs field vacuum expectation value $\left\langle v \right\langle \neq\neq 0$ which breaks the electroweak symmetry~\cite{pdg12}.
