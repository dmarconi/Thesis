...
with $a$ the confidence level expressed in terms of $\sigma$, and $S$ and $B$ the number of signal and background events for a given selection. One of the most important features of \autoref{eq::punzi_formula} that it is non-diverging in case of $B = 0$.
...
\begin{itemize}
	...
	\begin{itemize}
		\item two one-prong or three-prong hadronically decaying $\tau$ with $\pt = 20,25,30,35,40,45\gev$
...
for the optimal cuts of  $\pt(\hadtau) > 20\gev$,  $ \mjj> 500\gev $ and $\met > 120\gev$.
