...
%TODO I would move this to the strategy chapter. Once you have informed the reader about the topology you are interested in, you want to explain which are the backgrounds to expect. Then, in the analysis chapter it’s nice to motivate your object definitions and event selection by referring back to this background section.
...
%TODO I don’t see the point of so many graphs for backgrounds that don’t matter in the end. I’d reduce this drastically:
%TODO I would keep one VBF bkg graph, cause VBF is your topic
%TODO I would keep one V+jets,one tt, and one multijet graph because those are your main backgrounds
...
%TODO “modeling is reliable”, more careful would be to state that the rate and relative theoretical uncertainty on the rate is small compared to QCD
...
\begin{figure}[tbh!]
	...
	%TODO “one of the jets is reconstructed as a fake” rather say something like is part of background if one of the jets is reconstructed as a tau”	
...
%TODO a QCD event with a hard isolated t_h AND a fake t_h? that sounds really rare, perhaps impossible, is it relevant?
...
%TPDO PYTHIA part: what about jet-parton matching?
...
%TODO “For all…” you can remove that last sentence
...
%TODO This is *not* the general ABCD method, because you have this efficiency stuff. I know it comes down to the same thing, but you confuse the reader by saying that it is the QBCD method. May be remove the confusion bu saying that you use a method “equivalent” to the classic ABCD method.
...
%TODO it’s always good to give assumptions in the beginning. And you don’t really make the first assumption, cause you have corrections for the non QCD background.
